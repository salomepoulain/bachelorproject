...
from code.classes.WaterLoader import WaterLoader
...
class UnitcellBuilder:
    ...
    def read_xyz_clay(self, file_name):
    ...
    def add_solvent(self):
        ...
        waterbox.remove_outside_box((self.dimensions[0][1] - self.dimensions[0][0], self.dimensions[1][1] - self.dimensions[1][0], self.dimensions[2][1] - self.dimensions[2][0]))
        waterbox.remove_overlaying_water(self.molecules, self.dimensions)

        for molecule in waterbox.molecules:
            self.molecules.append(molecule)
        self.write_xyz(self.file_name + "_solvent")
    ...
    def add_ions_uniformly(self):
        ...
        # Only proceed if there are clay-type molecules
